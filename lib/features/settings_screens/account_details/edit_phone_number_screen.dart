...
import 'package:happy_pay_flutter/features/settings_screens/account_details/enter_otp_code_screen.dart';
...
class EditPhoneNumberScreen extends StatefulWidget {
  ...
  @override
  State<EditPhoneNumberScreen> createState() => _EditPhoneNumberState();
}
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (_) => const EnterOtpCodeScreen(),
                      settings: RouteSettings(arguments: fullNumber),
                    ),
                  );
                },
                style: ButtonStyle(

...
import 'package:happy_pay_flutter/features/loan/loan_pin_screen.dart';
...
class TermsLoanScreen extends StatefulWidget {
  const TermsLoanScreen({super.key});

  @override
  State<TermsLoanScreen> createState() => _TermsLoanScreenState();
}

class _TermsLoanScreenState extends State<TermsLoanScreen> {
